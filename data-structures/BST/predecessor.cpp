...
int predecessorHelper(binaryTreeNode* root, int data, int case_2_element){
    if(root == NULL){
        return -1;
    }
    if(data < root->data){
        return predecessorHelper(root->left, data, case_2_element);
    }
    if(data > root->data){
        return predecessorHelper(root->right, data, root->data);
    }
...
int predecessor(binaryTreeNode* root ,int data){
    if(root == NULL){
        return -1;
    }
    if(data < root->data){
        return predecessorHelper(root->left, data, -1);
    }
    else if(data > root->data){
        return predecessorHelper(root->right, data, root->data);
    }
...
cout<<predecessor(root,5)<<endl;
//case 2
cout<<predecessor(root,8)<<endl;
cout<<predecessor(root,4)<<endl;
//boundary case
cout<<predecessor(root,1)<<endl;
return 0;
}
